...
public class PrimeNumberCalculatorTest extends TestCase {
	...
	public void testPrimeNumbersBetween10And1() {
		int[] numbers = PrimeNumberCalculator.primes(10, 1);
		assertNotNull("Result for primes between 10 and 1 is not null.",
				numbers);
		assertEquals("4 prime numbers exist between 10 and 1", 4,
				numbers.length);
		assertEquals("1st prime number between 10 and 1 is 2.", 2, numbers[0]);
		assertEquals("2nd prime number between 10 and 1 is 3.", 3, numbers[1]);
		assertEquals("3rd prime number between 10 and 1 is 5.", 5, numbers[2]);
		assertEquals("4th prime number between 10 and 1 is 7.", 7, numbers[3]);
	}
